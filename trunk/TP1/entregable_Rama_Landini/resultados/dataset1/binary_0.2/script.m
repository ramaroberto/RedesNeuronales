...
%		for neurons1 = 5
			...
			weights_filename = ['../resultados/dataset' num2str(dataset) '/binary_0.2/pesos_fold' num2str(f) '_' num2str(neurons1) '_' num2str(modo) '_' num2str(max_epocas) '_' num2str(max_error) '.txt'];
			plot_filename = ['../resultados/dataset' num2str(dataset) '/binary_0.2/error_fold' num2str(f) '_' num2str(neurons1) '_' num2str(modo) '_' num2str(max_epocas) '_' num2str(max_error) '.pdf'];
