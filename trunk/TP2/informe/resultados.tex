...
\begin{document}
  ...
  \section{Resultados}
	...
	\item $C$ es ``Corte por épocas, norma Frobenius de matriz delta pesos mínima''
	\item $D$ es ``Corte por épocas, norma Frobenius de matriz delta pesos máxima''
    ...
    \subsection{Mapeo de características}
      ...
      Donde $DTr$ es el dataset de entrenamiento, $DTe$ es el dataset de validacion, $W$ es la matriz de pesos y $M_1, M_2$  son las dimensiones de la ultima. Se supone que $mAct$ calcula los mapas de dominantes para los datos otorgados y que $dM$ calcula la distancia euclidiana media entre dichos dominantes. En otra variacion de la metrica, $dM$ puede calculado utilizando distancia Manhattan.
